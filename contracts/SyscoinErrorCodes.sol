...
contract SyscoinErrorCodes {
    ...
    uint constant ERR_SUPERBLOCK_TIMESTAMP_SUPERBLOCK = 50062;
    uint constant ERR_SUPERBLOCK_TIMESTAMP_PREVBLOCK = 50063;
    ...
    uint constant ERR_SUPERBLOCK_TIMESTAMP_INTERIM_PREVBLOCK = 50068;
