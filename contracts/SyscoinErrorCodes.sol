...
contract SyscoinErrorCodes {
    ...
    uint constant ERR_SUPERBLOCK_INTERIMBLOCK_MISSING = 50230;
    uint constant ERR_SUPERBLOCK_BAD_INTERIM_PREVHASH = 50240;
    uint constant ERR_SUPERBLOCK_BAD_INTERIM_BLOCKINDEX = 50250;
