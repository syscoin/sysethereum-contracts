...
contract SyscoinErrorCodes {
    ...
    uint constant ERR_SUPERBLOCK_TIMESTAMP_SUPERBLOCK = 50061;
    uint constant ERR_SUPERBLOCK_TIMESTAMP_PREVBLOCK = 50062;
    uint constant ERR_SUPERBLOCK_BITS_LASTBLOCK = 50063;
    uint constant ERR_SUPERBLOCK_MIN_DEPOSIT = 50064;
