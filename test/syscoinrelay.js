...
const SyscoinRelayTest = artifacts.require('SyscoinRelayTest');

contract('SyscoinRelay', (accounts) => {
  let syscoinRelay;
  let syscoinRelayTest;

  describe("Test pure/view computation functions", () => {
    before(async () => {
      syscoinRelay = await SyscoinRelay.at(SyscoinRelay.address);
      syscoinRelayTest = await SyscoinRelayTest.at(SyscoinRelayTest.address);
    });
    ...
    it("scanBurnTx", async () => {
      ...
      const txBytes = "";
      const resultPos = await syscoinRelayTest.getOpReturnPos(txBytes, 4);
