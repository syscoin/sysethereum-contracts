...
contract('testSyscoinTokenDoUnlock', function(accounts) {
  ...
  it('doUnlock does not fail', async () => {
    ...
    assert.equal(burnHex.input, "0xa82e762b00000000000000000000000000000000000000000000000000000000773594009591c8dce6fcb35d000000000000000000000000000000000000000000000000");
